    ...
    <div class="container">
        ...
        <form action="#" class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="mLoc" id="mLoc" placeholder="지역 구분" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="mTitle" id="mTitle" placeholder="제목" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="mNum" id="mNum" placeholder="모집 인원" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="mKind" id="mKind" placeholder="모임 종류" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="mStatus" id="mStatus" placeholder="모임 상태 표시" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <input type="text" maxlength="100" name="mDate" id="mDate" placeholder="모임 일" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9 col-md-10 col-lg-10">
                    <textarea name="mContents" id="mContents" cols="20" rows="5" class="form-control"></textarea>
                </div>
            </div>
            <!--//내용 ---------------------------------------->
        </form>
